...
export const PERMISSIONS = {
  ...
  PLANNER_AGENT_LIST_MY_TASKS: 'planner:agent:listMyTasks',
  PLANNER_AGENT_LIST_MY_PLANS: 'planner:agent:listMyPlans',
  PLANNER_AGENT_LIST_EVIDENCE: 'planner:agent:listEvidence',
} as const
