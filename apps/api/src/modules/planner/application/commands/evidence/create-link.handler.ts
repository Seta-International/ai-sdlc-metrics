...
@CommandHandler(CreateEvidenceLinkCommand)
export class CreateEvidenceLinkHandler implements ICommandHandler<CreateEvidenceLinkCommand> {
  constructor(
  ...
  async execute(command: CreateEvidenceLinkCommand): Promise<void> {
    ...
    const evidence = TaskEvidence.createLink({
