...
import { PLANNER_SECRETS_STORE, type ISecretsStore } from '../../domain/ports/secrets-store.port'
...
@Injectable()
export class MsGraphTokenAcquirerAdapter implements IMsGraphTokenAcquirer {
  private readonly cache = new Map<string, CacheEntry>()
  private readonly expirySkewMs = 5 * 60 * 1000

  constructor(
    @Inject(PLANNER_SECRETS_STORE)
