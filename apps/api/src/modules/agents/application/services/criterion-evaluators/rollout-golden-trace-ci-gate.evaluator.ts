...
const CRITERION_ID = '18.5.golden_trace_ci_gate_enabled'
const { threshold } = CRITERION_THRESHOLDS[CRITERION_ID]

/**
 * §18.5 — Golden Trace CI Gate Enabled
 *
 * Checks whether the golden-trace CI gate check passed in the window.
 * passed = ciPassed === true
 */
@Injectable()
export class RolloutGoldenTraceCiGateEvaluator implements CriterionEvaluator {
