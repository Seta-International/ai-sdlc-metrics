 ...
 *
 * Plan 09: async turns under the read-only envelope may not execute
 ...
 *
 * Plan 08: MVP write scope enforcement.
...
export interface TurnPolicy {
  ...
  /**
   * Plan 08 — Whether `people.*` mutation tools are allowed for this turn.
