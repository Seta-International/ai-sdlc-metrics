...
describe('GoogleOAuthTokenExchanger', () => {
  ...
  let exchanger: GoogleOAuthTokenExchanger

  beforeEach(() => {
    fetchMock = vi.fn()
    globalThis.fetch = fetchMock as unknown as typeof fetch
    exchanger = new GoogleOAuthTokenExchanger()
  })
  ...
  it('POSTs to the token endpoint with authorization_code grant', async () => {
    ...
    expect(body).toContain('redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback%2Fgoogle')
  })
