...
|---|---|
| CEO | Leadership, Digital Transformation, Business Strategy |
| CTO | AWS, System Design, DevOps, Engineering Leadership |
| CDO | LLM, Machine Learning, Data Engineering, Python |
| IC Executive | Internal Communications, Employee Engagement, Town Hall Facilitation |
| PM | Agile, Scrum, JIRA, Risk Management, Product Roadmap |
| PMO | Portfolio Management, KPI, Governance, Resource Planning |
| Frontend Developer | React, TypeScript, Next.js, TailwindCSS, Testing |
| Backend Developer | Node.js, PostgreSQL, Redis, Docker, GraphQL, Kafka |
| Fullstack Developer | React, Node.js, TypeScript, PostgreSQL, Docker |
| Talent Acquisition | Technical Recruiting, LinkedIn Recruiter, Onboarding |
| IT | AWS, Kubernetes, Terraform, Linux, Monitoring, Security |
