...
module.exports = {
  ...
  queryTransformer: (query: Record<string, unknown>, { securityContext }: { securityContext?: Record<string, unknown> }) => {
    ...
    return {
      ...
      filters: [
        ...
        { member: `${measures?.[0]?.split('.')[0]}.tenantId`, operator: 'equals', values: [tenantId] },
      ],
    }
  },
