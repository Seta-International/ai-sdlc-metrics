...
Mastra ships an internal package `@internal/llm-recorder` (`/Users/canh/Projects/Seta/mastra/packages/_llm-recorder/`) that intercepts outbound HTTP via MSW (not via wrapping the SDK client) so recording works uniformly across OpenAI / Anthropic / Google / OpenRouter (`/Users/canh/Projects/Seta/mastra/packages/_llm-recorder/src/llm-recorder.ts:63-65`, providers listed README:307-314).
