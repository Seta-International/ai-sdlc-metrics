...
ALTER TABLE "identity"."idp_group_mapping" FORCE ROW LEVEL SECURITY;
...
ALTER TABLE "identity"."magic_link_token" FORCE ROW LEVEL SECURITY;
CREATE POLICY "tenant_isolation" ON "identity"."magic_link_token"
  USING (tenant_id = current_setting('app.tenant_id', true)::uuid);

ALTER TABLE "identity"."api_key" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "identity"."api_key" FORCE ROW LEVEL SECURITY;
