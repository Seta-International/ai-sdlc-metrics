...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        'flex items-center rounded-sm px-2 py-1 text-sm font-510 outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground',
        className,
      )}
      {...props}
    />
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          'z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-[0px_2px_4px_rgba(0,0,0,0.4)] data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
          className,
        )}
        {...props}
      />
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn('px-2 py-1.5 text-sm font-510 data-[inset]:pl-8', className)}
      {...props}
    />
  )
}
